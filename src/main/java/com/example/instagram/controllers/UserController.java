...
public class UserController {
    ...
    public ResponseEntity<User> registr(String username, String password, Model model) {
    ...
    @PostMapping("/auth")
    public ResponseEntity<User> auth(String username, String password, Model model, HttpSession mod) {
        if (!userService.existByUserName(username)) {
